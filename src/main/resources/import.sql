...
CREATE TABLE `t_article` (
  ...
  `articleType` int(4) NOT NULL COMMENT '文章类型',
  `title` varbinary(500) DEFAULT NULL COMMENT '文章标题',
  `summary` varbinary(500) DEFAULT NULL COMMENT '文章摘要',
...
INSERT INTO t_article (title, summary, content, articleType, createTime, updateTime) VALUES
