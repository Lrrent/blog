        ...
        <div class="wrap-col">
          <article>
            <div class="content"> <img src="images/img1.jpg" width="120px" height="120px"/>
              ...
              <div style="font-size:14px;">2016-3-19-<a href="#">wutong</a> <a class="a2" href="news_detail.html">阅读全文</a> </div>
            </div>
          </article>
          <article>
            <div class="content"> <img src="images/img1.jpg" width="120px" height="120px"/>
        ...
        <div class="box">
          ...
          <div class="content">
            <ul>
              ...
              <li><a href="#">Web 架构WeWeb 架构</a></li>
              <li><a href="#">基础技术</a></li>
              <li><a href="#">资讯  Web 架构  基础技术 书籍</a></li>
            </ul>
          </div>
        </div>
        <div class="box">
